...
Sin embargo, todavia no existe `sdd-cli reject`.
...
| Capacidad | Estado |
| --- | --- |
| `sdd-cli reject` | Regla de dominio existente, comando ausente |
| `sdd-cli archive` | Fase declarativa existente, movimiento fisico ausente |
